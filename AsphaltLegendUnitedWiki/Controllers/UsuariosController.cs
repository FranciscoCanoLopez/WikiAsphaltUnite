...
namespace AsphaltLegendUnitedWiki.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(AsphaltDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreUsuario,Email,PasswordHash,Rol,FechaRegistro")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreUsuario,Email,PasswordHash,Rol,FechaRegistro")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
